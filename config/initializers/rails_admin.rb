# RailsAdmin config file. Generated on February 19, 2013 12:47
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Phrasee', 'Admin']
  ...
  # config.excluded_models = ['AdminUser', 'Category', 'Comment', 'Favorite', 'Goiken', 'Phrase', 'Resignation', 'Role', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['AdminUser', 'Category', 'Comment', 'Favorite', 'Goiken', 'Phrase', 'Resignation', 'Role', 'User']
  ...
  #     configure :phrases, :has_many_association 

  #   # Found columns:

  #     configure :id, :integer 
  #     configure :category_name, :string 
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
  ...
  #     configure :phrase, :belongs_to_association 
  ...
  #     configure :phrase_id, :integer         # Hidden 
  ...
  # config.model 'Goiken' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your goiken.rb model definition
  ...
  # config.model 'Phrase' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your phrase.rb model definition
  ...
  # config.model 'Resignation' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your resignation.rb model definition
  ...
  #     configure :profile_image, :carrierwave 
