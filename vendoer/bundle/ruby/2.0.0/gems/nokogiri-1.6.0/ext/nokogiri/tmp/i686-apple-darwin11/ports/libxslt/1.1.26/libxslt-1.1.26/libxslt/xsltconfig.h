...
#define WITH_MODULES
#endif
#define LIBXSLT_DEFAULT_PLUGINS_PATH() "/Applications/MAMP/htdocs/rails/phrasee/vendoer/bundle/ruby/2.0.0/gems/nokogiri-1.6.0/ports/i686-apple-darwin11/libxslt/1.1.26/lib/libxslt-plugins"
#endif
